  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Terms, [{
    ...
    value: function render() {
      ...
      return __jsx("div", {
        ...
        // const label = `(${getWeddingsYearAmount(year.details)}) ${year.name}`;
        var label = __jsx("div", {
          className: classes.labelOfYear,
          __source: {
            fileName: _jsxFileName,
            lineNumber: 72
          },
          __self: this
        }, year.name, getWeddingsYearAmount(year.details));
...
//# sourceMappingURL=blablaterms.js.48e611af632055707c76.hot-update.js.map