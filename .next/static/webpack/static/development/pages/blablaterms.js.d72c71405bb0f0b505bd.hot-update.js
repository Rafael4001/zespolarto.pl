...
/* harmony import */ var _src_constants__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../src/constants */ "./src/constants.js");
...
var CustomBodyOfMonth = function CustomBodyOfMonth(_ref) {
  ...
  var classNameMain = classnames__WEBPACK_IMPORTED_MODULE_2___default()(classes.main, (_classNames = {}, Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(_classNames, classes.busy, status === _src_constants__WEBPACK_IMPORTED_MODULE_9__["STATUS"].BUSY), Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(_classNames, classes.holiday, status === _src_constants__WEBPACK_IMPORTED_MODULE_9__["STATUS"].HOLIDAY), Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(_classNames, classes.emptyContainer, status === _src_constants__WEBPACK_IMPORTED_MODULE_9__["STATUS"].EMPTY || _src_constants__WEBPACK_IMPORTED_MODULE_9__["STATUS"].UNDEFINED), _classNames));

  var getView = function getView(status) {
    switch (status) {
      case _src_constants__WEBPACK_IMPORTED_MODULE_9__["STATUS"].BUSY:
        return __jsx("div", {
      ...
      case _src_constants__WEBPACK_IMPORTED_MODULE_9__["STATUS"].HOLIDAY:
        return __jsx("div", {
  ...
  var getIcon = function getIcon(status) {
    switch (status) {
      ...
      case _src_constants__WEBPACK_IMPORTED_MODULE_9__["STATUS"].EMPTY:
  ...
  var getDetails = function getDetails() {
    return __jsx("div", {
      ...
      __self: this
    }, (status === _src_constants__WEBPACK_IMPORTED_MODULE_9__["STATUS"].BUSY || status === _src_constants__WEBPACK_IMPORTED_MODULE_9__["STATUS"].HOLIDAY) && __jsx("div", {
      __source: {
        fileName: _jsxFileName,
        lineNumber: 57
      },
  ...
  return __jsx("div", {
    ...
    __self: this
  }, "(", weekDay, ")"), isDayExpanded ? __jsx(_material_ui_icons_ExpandLess__WEBPACK_IMPORTED_MODULE_7___default.a, {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 74
    },
    ...
    __self: this
  })), isDayExpanded && getDetails()), __jsx("div", {
...
CustomBodyOfMonth.defaultProps = {
  ...
  status: '',
  weddingHour: '',
  weekDay: _src_constants__WEBPACK_IMPORTED_MODULE_9__["WEEK_DAY"].SATUDRAY
};
CustomBodyOfMonth.propTypes = {
  classes: prop_types__WEBPACK_IMPORTED_MODULE_10___default.a.object.isRequired,
  day: prop_types__WEBPACK_IMPORTED_MODULE_10___default.a.string,
  description: prop_types__WEBPACK_IMPORTED_MODULE_10___default.a.string,
  hotel: prop_types__WEBPACK_IMPORTED_MODULE_10___default.a.string,
  information: prop_types__WEBPACK_IMPORTED_MODULE_10___default.a.string,
  place: prop_types__WEBPACK_IMPORTED_MODULE_10___default.a.string,
  status: prop_types__WEBPACK_IMPORTED_MODULE_10___default.a.string,
  weddingHour: prop_types__WEBPACK_IMPORTED_MODULE_10___default.a.string,
  weekDay: prop_types__WEBPACK_IMPORTED_MODULE_10___default.a.string
};
...
//# sourceMappingURL=blablaterms.js.d72c71405bb0f0b505bd.hot-update.js.map