    ...
    value: function render() {
      ...
      var getWeddingsYearAmount = function getWeddingsYearAmount(yearDetails) {
        ...
        var YYYY = yearDetails.map(function (month) {
          ...
          console.log('weddingsAmount', allweeddings);
          return YYYY;
        });
      };
      ...
      return __jsx("div", {
        ...
        var label = "".concat(year.name, " ").concat(getWeddingsYearAmount(year.details));
...
//# sourceMappingURL=blablaterms.js.6d324e62d352c76c299c.hot-update.js.map