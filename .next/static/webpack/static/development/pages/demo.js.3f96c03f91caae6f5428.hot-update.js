...
/* harmony import */ var _trackList__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../../trackList */ "./src/trackList.js");
...
var tracks = _trackList__WEBPACK_IMPORTED_MODULE_16__["TRACK_LIST"];
...
function (_Component) {
  ...
  function PlayerCustomized() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_4__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_2__["default"])(_this), "showWhatSongIsPlaying", function (song) {
      return song.mp3Name === _this.state.actualPlayingTrackMp3Name;
    });
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_4__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_2__["default"])(_this), "playNextSong", function () {
      var actualSongIndex = tracks.findIndex(_this.showWhatSongIsPlaying);
      var newSongIndex = actualSongIndex + 1;
      var nextSong = tracks[newSongIndex];
      ...
      _this.setState({
        ...
        autoplay: true,
        isPlaying: true,
        actualSongImage: nextSong.imgSrc ? nextSong.imgSrc : _constants__WEBPACK_IMPORTED_MODULE_11__["SONGS_IMAGES"].DefaultSongImage
      });
    });
...
var TRACK_LIST = [{
  ...
  imgSrc: _constants__WEBPACK_IMPORTED_MODULE_0__["SONGS_IMAGES"].dajToGlosniej
}, {
  name: 'Miła ma',
  mp3Name: 'mila_ma',
  artist: 'Power Play',
  ...
  artist: 'Lombard' // imgSrc: SONGS_IMAGES.poparzeniKawaTrzy,
  ...
  artist: 'Czadomen' // imgSrc: SONGS_IMAGES.poparzeniKawaTrzy,
...
//# sourceMappingURL=demo.js.3f96c03f91caae6f5428.hot-update.js.map