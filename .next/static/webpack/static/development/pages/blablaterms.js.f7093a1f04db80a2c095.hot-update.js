...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Terms, [{
    ...
    value: function render() {
      ...
      var getWeddingsYearAmount = function getWeddingsYearAmount() {
        var allweeddings = 0;
        var YYYY = _termsJSON_terminy2020__WEBPACK_IMPORTED_MODULE_13__.map(function (month) {
          ...
          console.log('weddingsAmount', allweeddings); // return
        });
      };
      ...
      return __jsx("div", {
        ...
        //TUTAJ JESTE MIEJSCE NA FILTR
        {
          getWeddingsYearAmount(year.details);
        }
...
//# sourceMappingURL=blablaterms.js.f7093a1f04db80a2c095.hot-update.js.map