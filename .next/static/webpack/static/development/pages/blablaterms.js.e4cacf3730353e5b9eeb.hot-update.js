  ...
  var getMonths = function getMonths(months) {
    return months.map(function (month) {
      ...
      var isBusy = function isBusy(value) {
        return value.status === _constants__WEBPACK_IMPORTED_MODULE_5__["STATUS"].EMPTY;
      };

      var ileWeselWMies = month.days.filter(isBusy);
      console.log('ileWeselWMies', ileWeselWMies);
      return __jsx("li", {
        key: month.name,
...
//# sourceMappingURL=blablaterms.js.e4cacf3730353e5b9eeb.hot-update.js.map