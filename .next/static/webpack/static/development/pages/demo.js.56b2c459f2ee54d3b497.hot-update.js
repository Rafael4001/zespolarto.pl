...
function (_Component) {
  ...
  function PlayerCustomized() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_4__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_2__["default"])(_this), "playNextSong", function () {
      ...
      var HHH = tracks.findIndex(_this.blabla);
      console.log(HHH);
      var newSong = HHH + 1;
      var JJJ = tracks[newSong];
      console.log(JJJ);

      _this.setState({
        actualPlayingTrackMp3Name: JJJ.mp3Name,
        actualSongName: JJJ.name,
        autoplay: true,
        isPlaying: true,
        actualSongImage: JJJ.imgSrc ? JJJ.imgSrc : _constants__WEBPACK_IMPORTED_MODULE_11__["SONGS_IMAGES"].DefaultSongImage
      });
    });
...
//# sourceMappingURL=demo.js.56b2c459f2ee54d3b497.hot-update.js.map